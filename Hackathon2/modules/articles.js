...
const getAllArticles = () => {
  return db("articles").select("id", "title", "date_data", "body").orderBy("title");
};

const getArticle = (article_id) => {
  return db("articles").select("id", "title", "date_data", "body").where({ id: article_id });
};

const searchArticles = (article_title) => {
  return db("articles").select("id", "title", "date_data", "body").whereILike("title", `${article_title}%`);
};
